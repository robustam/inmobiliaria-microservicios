...
// ============================================================
// MANEJADOR GLOBAL DE EXCEPCIONES - RESEÑA SERVICE
// ============================================================
...
public class GlobalExceptionHandler {
    ...
    // RecursoNoEncontradoException → HTTP 404 (reseña no existe)
    ...
    // NegocioException → HTTP 400 (calificación inválida u otra regla)
