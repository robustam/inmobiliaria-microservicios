...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleValidationErrors(
        ...
        log.warn("Error de validacion en busqueda-service: {}",
                ex.getMessage());
    ...
    // Ejemplo: error al conectar con propiedad-service
    @ExceptionHandler(RuntimeException.class)
    public ResponseEntity<?> handleRuntimeException(
            RuntimeException ex) {

        log.error("Error de negocio en busqueda-service: {}",
                ex.getMessage());
    ...
    public ResponseEntity<?> handleGenericException(
        ...
        log.error("Error inesperado en busqueda-service: {}",
                ex.getMessage());
