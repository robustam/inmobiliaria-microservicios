...
public class GlobalExceptionHandler {
    ...
    // Ejemplo: usuarioId nulo, mensaje vacio
    @ExceptionHandler(MethodArgumentNotValidException.class)
    public ResponseEntity<?> handleValidationErrors(
            MethodArgumentNotValidException ex) {

        log.warn("Error de validacion en notificacion-service: {}",
                ex.getMessage());
    ...
    // Ejemplo: notificacion no encontrada
    @ExceptionHandler(RuntimeException.class)
    public ResponseEntity<?> handleRuntimeException(
            RuntimeException ex) {

        log.error("Error de negocio en notificacion-service: {}",
                ex.getMessage());
    ...
    public ResponseEntity<?> handleGenericException(
        ...
        log.error("Error inesperado en notificacion-service: {}",
                ex.getMessage());
